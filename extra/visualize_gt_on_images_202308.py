...
train_or_val = 'train'
root_folder = '/home/matteo/.lab0/data/Datasets/Existing/202308/'
ann_file = root_folder + f'/annotations/COCO/dataset_20230818.json'
img_dir = root_folder + f'/images/'
out_dir = root_folder + f'/visualization'
