...
root_folder = '/workspace/data/Datasets/Existing/20250711/202507_fine_tuning_1'
ann_file = root_folder + f'/training_annotations/coco_annotations.json'
img_dir = root_folder + f'/training_images/'
out_dir = root_folder + f'/gt_visualization'
