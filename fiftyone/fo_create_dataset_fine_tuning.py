...
# SET THE NAME OF THE DATASET HERE.
dataset_name = 'fine_tuning'
print(f'Dataset name = {dataset_name}')

# 1. Create the dataset, load images and GT labels.
print('\n1. Create the dataset, load images and GT labels.')
image_dir = "/home/matteo/.lab0/data/Datasets/fine_tuning_2025_12_19/training_images/"
dataset = fo.Dataset.from_dir(
    dataset_type=fo.types.COCODetectionDataset,
    data_path=image_dir,
    labels_path="/home/matteo/.lab0/data/Datasets/fine_tuning_2025_12_19/training_annotations/annotations.json",
...
# 2. Load predictions.
print('\n2. Load predictions.')
prediction_path = "/home/matteo/.lab0/data/EOMT/Output/val_on_ft_training/"
dataset.merge_samples(
    fo.Dataset.from_dir(
        dataset_type=fo.types.COCODetectionDataset,
        data_path=image_dir,
        labels_path=prediction_path + "predictions.json",
        label_types="segmentations",
...
results = dataset.evaluate_detections(
    ...
    backend="masks",       # Use the segments, not the BBs. Not sure if this is useful.
    use_masks=True         # Use the segments, not the BBs.
)

# 7. Compute the F1 score for each image. [Not very useful, can be skipped.]
print('\n7., 8. and 9.')
print('7. Compute the Semantic Segmentation IoU for each image.')
print('8. Compute the F1 score for each image.')
print('9. Create labels for False Positives and Missed Detections (FN).')
...
for sample in tqdm(dataset):
    ...
    # Create labels for False Positives.
    ...
    # Create labels for False Negatives.
...
# Save the dataset to MongoDB. WARNING: It seems that the dataset is only saved after we open the visualization.
print('\n12. Save the dataset.')
dataset.save()

# Export data to CSV file.
print('\n13. Save info to a CSV file.')
try:
    ...
    print(f'It was not possible to save information to the CSV file. {E}')
